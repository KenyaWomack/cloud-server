...
First, ensure that you've installed the [AWS CLI](http://cloud-server-dev2.us-east-2.elasticbeanstalk.com/) and the [aws eb](http://lab16-env.eba-m55qxw2n.us-east-2.elasticbeanstalk.com/) command line utilities.
